...
st.set_page_config(page_title="Sura Sindhu", layout="wide")

# Title
st.title("Sura Sindhu Image - Multi-Color Channel Visualizer")

# Load image from local path
@st.cache_data
def load_image():
    path = r"C:\Users\suras\OneDrive\Pictures\Camera Roll\WhatsApp Image.jpg"
